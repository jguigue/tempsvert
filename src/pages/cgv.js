...
export default function () {
  return (
    <LayoutOne title="CGV - Le Temps Verts">
      <Breadcrumb title="Conditions Générales de Ventes">
        <BreadcrumbItem name="Accueil" />
        <BreadcrumbItem name="Conditions Générales de Ventes" current />
      </Breadcrumb>
...
TEMPS VERTS
Société SAS au capital de 1 000 euros
Siège social 10 chemin du bosquet 83000 Toulon ;
N° de téléphone ; Adresse du courrier électronique contact@guiguejulien.com;
RCS (ou Répertoire des métiers) de n° ;
TVA Intra-communautaire n°;
Le responsable de la publication personne physique est Julien GUIGUE;



<h1>Conditions générales de vente des produits vendus sur Temps Verts</h1>

Date de dernière mise à jour

<h2>Article 1 - Objet</h2>

Les présentes conditions régissent les ventes par la société TEMPS VERTS 10 chemin du bosquet 83000 Toulon de .
...
Sur Internet : <a href="https://tempsverts.netlify.app">https://tempsverts.netlify.app</a>
...
La société <b>TEMPS VERTS</b> se réserve le droit de ne pas enregistrer un paiement, et de ne pas confirmer une commande pour quelque raison que ce soit, et plus particulièrement en cas de problème d'approvisionnement, ou en cas de difficulté concernant la commande reçue.

<h2>Article 4 - Validation de votre commande</h2>

Toute commande figurant sur le site Internet <a href="https://tempsverts.netlify.app">https://tempsverts.netlify.app</a> suppose l'adhésion aux présentes Conditions Générales. Toute confirmation de commande entraîne votre adhésion pleine et entière aux présentes conditions générales de vente, sans exception ni réserve.
...
En cas d'exercice du droit de rétractation, la société <b>TEMPS VERTS</b> procédera au remboursement des sommes versées, dans un délai de 14 jours suivant la notification de votre demande et via le même moyen de paiement que celui utilisé lors de la commande.
...
Nos produits sont proposés tant qu'ils sont visibles sur le site <a href="https://tempsverts.netlify.app">https://tempsverts.netlify.app</a> et dans la limite des stocks disponibles. Pour les produits non stockés, nos offres sont valables sous réserve de disponibilité chez nos fournisseurs.
...
En outre, le site Internet <a href="https://tempsverts.netlify.app">https://tempsverts.netlify.app</a> n'a pas vocation à vendre ses produits en quantités importantes. Par conséquent la société <b>TEMPS VERTS</b> se réserve le droit de refuser les commandes de articles identiques.
...
En cas de livraisons par une transporteur, la société <b>TEMPS VERTS</b> ne peut être tenue pour responsable de retard de livraison dû exclusivement à une indisponibilité du client après plusieurs propositions de rendez-vous.
...
Les produits proposés sont conformes à la législation française en vigueur. La responsabilité de la société <b>TEMPS VERTS</b> ne saurait être engagée en cas de non-respect de la législation du pays où le produit est livré. Il vous appartient de vérifier auprès des autorités locales les possibilités d'importation ou d'utilisation des produits ou services que vous envisagez de commander.

Par ailleurs, la société <b>TEMPS VERTS</b> ne saurait être tenue pour responsable des dommages résultant d'une mauvaise utilisation du produit acheté.

Enfin la responsabilité de la société <b>TEMPS VERTS</b> ne saurait être engagée pour tous les inconvénients ou dommages inhérents à l'utilisation du réseau Internet, notamment une rupture de service, une intrusion extérieure ou la présence de virus informatiques.
...
Tous les éléments du site <a href="https://tempsverts.netlify.app">https://tempsverts.netlify.app</a> sont et restent la propriété intellectuelle et exclusive de la société <b>TEMPS VERTS</b>. Nul n'est autorisé à reproduire, exploiter, rediffuser, ou utiliser à quelque titre que ce soit, même partiellement, des éléments du site qu'ils soient logiciels, visuels ou sonores. Tout lien simple ou par hypertexte est strictement interdit sans un accord écrit exprès de la société <b>TEMPS VERTS</b>.

Article 13 - Données personnelles

La société <b>TEMPS VERTS</b> se réserve le droit de collecter les informations nominatives et les données personnelles vous concernant. Elles sont nécessaires à la gestion de votre commande, ainsi qu'à l'amélioration des services et des informations que nous vous adressons.
...
La société <b>TEMPS VERTS</b> archivera les bons de commandes et les factures sur un support fiable et durable constituant une copie fidèle conformément aux dispositions de l'article 1348 du Code civil.

Les registres informatisés de la société <b>TEMPS VERTS</b> seront considérés par toutes les parties concernées comme preuve des communications, commandes, paiements et transactions intervenus entre les parties.
