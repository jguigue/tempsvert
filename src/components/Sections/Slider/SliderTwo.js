                ...
                <div className="slider-background">
                  ...
                  >
                    <video
                      ...
                      muted
                    >
                    <source src={process.env.PUBLIC_URL + slide.mp4} type="video/mp4"/>
                    <source src={process.env.PUBLIC_URL + slide.webm} type="video/webm"/>
                    </video>
                ...
                <div className="slider-content">
                  ...
                  <div className="slider-animation-wrapper">
                    ...
                    >
                      <div>
                        <Button
                          action={process.env.PUBLIC_URL + "#intro"}
